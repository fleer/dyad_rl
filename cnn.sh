...
run_exp "Exp ${i} — Baseline CNN on Samegame 2x3c3s2" \
  ...
  experiment_name="exp_cnn_samegame2x3c3s2_1"
#
...
# python plot_results.py --experiments results/exp_cnn_samegame2x3c3s2_averaged/agent_eval.json results/exp_dyad_cnn_mlp_samegame2x3c3s2_averaged/agent_a_eval.json results/exp_dyad_cnn_mlp_samegame2x3c3s2_averaged/agent_b_eval.json
#
# python plot_dyad_sharing.py results/exp_dyad_cnn_mlp_samegame2x3c3s2_averaged/sharing_stats.json
